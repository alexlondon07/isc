...
//include 'lib/ControllerDimensiones.php';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <section id="section_wrap">
            ...
            <div class="container">
                ...
                //if ($create) {
                ?>
                <a href="#" id="creardimensiones" class="btn btn-info botoncrear">Crear</a>
                <?php
                //}
                ?>
                <div>
                    <table class="table table-hover dyntable" id="dynamictable">
                        <thead>
                            <tr>
                                ...
                                <th class="head0">Valor de dimensión</th>
                            </tr>
                        </thead>
                        <colgroup>
                            <col class="con0" />
        ...
        <div id="dialog-form" title="Dimensiones" style="display: none;">
            ...
            <form class="form-horizontal" id="formcreate">
                ...
                <div class="alinear"  style="width: 45%; display: inline-block; vertical-align: top;"  id="divform">
                    <div class="control-group">
                        ...
                        <div class="controls"><input type="text" name="valor_sector" id="valor_sector" class="text ui-widget-content ui-corner-all" /></div>
                    </div>
                    <div class="control-group">
        ...
        <div id="dialog-formsc" title="Sectores" style="display: none;">
            ...
            <form class="form-horizontal" id="formcreate">
                <div class="alinear"  style="width: 45%; display: inline-block; vertical-align: top;"  id="divform">
                    ...
                    <div class="control-group">
                        <label class="control-label">Dimenciones Disponibles</label>
                        <div class="controls"><input readonly type="text" name="iddimensc" id="iddimensc" class="text ui-widget-content ui-corner-all" /></div>
                    </div>
                </div>
                <div class="alinear"  style="width: 45%; display: inline-block; vertical-align: top;"  id="divform">
                    <div class="control-group">
                        <label class="control-label">Valor del Sector Social</label>
                        <div class="controls"><input readonly type="text" name="valor_sectorsc" id="valor_sectorsc" class="text ui-widget-content ui-corner-all" /></div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Valor del Sector Social</label>
                        <div class="controls"><input readonly type="text" name="dime_relacionadassc" id="dime_relacionadassc" class="text ui-widget-content ui-corner-all" /></div>
                    </div>
                </div>
            </form>
        </div>
