...
class Util {
    ...
    public $THE_KEY = '7e8a62d6111ee2a7aa778d3f3ff75c19';
...
//	    $str = date("Y-m-d H:i:s")." # ".__FILE__." Linea: ".__LINE__."\n".$str."\n";
    ...
    public function error_missing_data_file() {
        return array('output' => array('valid' => false, 'response' => array('code' => '103', 'content' => ' El archivo no subió correctamente.')));
    }
    ...
    public function error_wrong_data_login($q = '') {
        return array('output' => array('valid' => false, 'response' => array('code' => '107', 'content' => ' Usuario o Contraseña Incorrectos. ***'.$q)));
    }
    ...
    public function error_contact_asocied() {
        return array('output' => array('valid' => false, 'response' => array('code' => '110', 'content' => ' Hay un contacto asociado, no se puede eliminar.')));
    }
