...
//include 'lib/ControllerPreguntas.php';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div id="dialog-form" title="Preguntas" style="display: none;">
        ...
        <div id="dialog-formsc" title="Preguntas" style="display: none;">
            <p class="validateTips"></p>
            <form class="form-horizontal" id="formcreate">
                <div class="control-group">
