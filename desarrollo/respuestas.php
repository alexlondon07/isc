...
//include 'lib/ControllerRespuestas.php';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <section id="section_wrap">
            ...
            <div class="container">
                ...
                //if ($create) {
                ?>
                <a href="#" id="crearrespuestas" class="btn btn-info botoncrear">Crear</a>
                <?php
                //}
                ?>
                <div>
        ...
        <div id="dialog-form" title="Respuestas" style="display: none;">
        ...
        <div id="dialog-formsc" title="Respuestas" style="display: none;">
            <p class="validateTips"></p>
            <form class="form-horizontal" id="formcreate">
                <div class="control-group">
                    <label class="control-label">Criterio</label>
